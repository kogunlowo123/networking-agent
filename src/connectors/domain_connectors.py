"""Networking Agent - Domain-Specific Connectors."""
...
class TerraformCliConnector:
    """Domain-specific connector for terraform cli integration with Networking Agent."""
...
class AwsProviderConnector:
    """Domain-specific connector for aws provider integration with Networking Agent."""
...
class AzureProviderConnector:
    """Domain-specific connector for azure provider integration with Networking Agent."""
...
class GcpProviderConnector:
    """Domain-specific connector for gcp provider integration with Networking Agent."""
...
class InfracostConnector:
    """Domain-specific connector for infracost integration with Networking Agent."""
