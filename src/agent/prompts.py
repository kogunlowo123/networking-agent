"""Networking Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Networking Agent, a cloud architecture specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Networking Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Networking Agent:
